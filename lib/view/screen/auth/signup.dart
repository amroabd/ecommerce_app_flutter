    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: SizedBox(width: double.infinity,
          child: Text(
            Strings.loginTitleSignupKey.tr,textAlign: TextAlign.center,
      ...
      body: GetBuilder<SignUpControllerImp>(builder:(controller)=> WillPopScope(
        ...
        child: controller.myRequestState.state==RequestState.loading?
          ...
          Form(
            ...
            child: ListView(
              children: [
                ...
                CustomTextForm(
                  validator: (value)=>validateInput(value!, 3, 30,StringsEn.loginTitleUsername),
                ...
                CustomTextForm(
                  validator: (value)=>validateInput(value!, 5, 30, StringsEn.loginTitlePassword),
                ...
                CustomTextForm(
                  validator: (value)=>validateInput(value!, 5, 30, StringsEn.emailTitleAccount),
                ...
                CustomTextForm(
                  validator: (value)=>validateInput(value!, 6, 15, StringsEn.phoneTitleAccount),
